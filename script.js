...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const texts = ["Tech Enthusiast", "Web Developer"]; // Add more if needed
    let textIndex = 1;
    let charIndex = 0;

    function typeEffect() {
        if (charIndex < texts[textIndex].length) {
            titleElement.innerHTML += texts[textIndex].charAt(charIndex);
            charIndex++;
            setTimeout(typeEffect, 100);
        } else {
            // Wait a bit, then erase and show the next text
            setTimeout(() => {
                titleElement.innerHTML = "";
                charIndex = 0;
                textIndex = (textIndex + 1) % texts.length;
                typeEffect();
            }, 1500); // Pause before switching text
        }
    }
...
//ciseron jefrry's portfolio script for the announcement section
...
// ciseron jefrry's portfolio script for  hamburger menu toggle open and close
...
//ciseron jefrry's portfolio script for about section 
...
// ciseron jefrry's portfolio  function to scroll to next section  while clicking on arrow
...
//ciseron jefrry's portfolio script for skills section
...
// ciseron jefrry's portfolio script for achievement section
document.addEventListener('DOMContentLoaded', function () {
...
// ciseron jefrry's portfolio script for project section
document.addEventListener('DOMContentLoaded', function() {
...
function viewProject(projectId) {
    switch (projectId) {
        case 'project1':
            ...
            break;
        case 'project2':
            window.open(" https://ciseronjefrry.github.io/Photophile_Professional-Photography-Hub/", "_blank"); 
            break;
        case 'project3':
            // window.open("#", "_blank"); 
...
function viewCode(projectId) {
    switch (projectId) {
        case 'project1':
            ...
            break;
        case 'project2':
            window.open("https://github.com/ciseronjefrry/Photophile_Professional-Photography-Hub", "_blank"); 
            break;
        case 'project3':
            // window.open("#", "_blank"); 
...
// ciseron jefrry's portfolio script for the certificate section
document.addEventListener('DOMContentLoaded', () => {
...
// ciseron jefrry's portfolio script for contact section
